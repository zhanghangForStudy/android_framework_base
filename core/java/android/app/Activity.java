...
public class Activity extends ContextThemeWrapper
    ...
    public Object getSystemService(@ServiceName @NonNull String name) {
        ...
        if (WINDOW_SERVICE.equals(name)) {
            // 对于activity如果是获取WindowManager,则直接返回自身的windowmanager对象
            return mWindowManager;
     ...
     * 设置基本的ContextImpl对象
     * 设置一些基本的属性值
     * 主要创建了Window对象和以此Window对象为父Window的WindowManager对象；
     *
     *
     * @param context                       activity的基础ContextImpl对象
     * @param aThread                       ActivityThread对象
     * @param instr
     * @param token                         AMS的activityrecord的远程引用
     * @param ident                         AMS中对应的activityrecord对象的hascode
     * @param application                   Application对象
     * @param intent                        启动此activity的原始intent
     * @param info                          xml文件中activity相关的定义信息
     * @param title                         名字
     * @param parent                        父activity
     * @param id                            嵌入的ID
     * @param lastNonConfigurationInstances 最新的非配置的实例
     * @param config                        配置信息
     * @param referrer                      启动此activity的原始包名
     * @param voiceInteractor               与音频相关的接口
     * @param window
     */
