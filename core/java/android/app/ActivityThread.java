...
public final class ActivityThread {
    ...
    private class ApplicationThread extends ApplicationThreadNative {
        ...
        /**
         * 向主线程发送一个消息，用以处理指定activity的暂停
         *
         * @param token         AMS中activityrecord在此应用进程中的代表
         * @param finished      要暂停的acitivity是否已经结束了
         * @param userLeaving   是否回调activity的onUserLeaving方法
         * @param configChanges
         * @param dontReport    是否需要报告暂停结果
         */
    ...
    /**
     * 处理指定activity的暂停行为；此方法在主线程中被执行
     *
     * @param token         AMS中ActivityRecord对象在此应用进程中的代表
     * @param finished      AMS中ActivityRecord对象的状态是否结束了
     * @param userLeaving   是否需要回调activity的onUserLeaving方法
     * @param configChanges
     * @param dontReport    是否需要向AMS报告暂停的结果
     * @param seq
     */
