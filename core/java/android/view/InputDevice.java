...
public final class InputDevice implements Parcelable {
     ...
     * 一次触摸事件应该根据视图树，作为一个绝对的屏幕坐标点来被解释。
     * 指尖按下和释放表示了手指触摸显示屏幕的事件，或者可选择按钮被按下/释放的时间
     ...
     * 使用getMotionRange来确定触摸设备的可触摸范围。
     * 一些设备允许触摸显示屏幕的外界区域，所以有效的范围可能比真实的显示屏幕尺寸小点或者大点
     */
